...
public class JwtTokenUtil {
	private String secret = "Grocery Delivery@2023"; // this secret is used to generate token,validate token

	public static void main(String[] args) {

		JwtTokenUtil util = new JwtTokenUtil();
		String token = util.generateToken("300", "kusuma@gmail.com", "2");
	...
	public String generateToken(String id, String user, String roleId) {
		...
		try {
			token = Jwts.builder().setId(id)// Consumer ID
					...
					.setIssuer("Grocery Delivery").setIssuedAt(new Date(System.currentTimeMillis()))
